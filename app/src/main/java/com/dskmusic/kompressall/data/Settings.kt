...
object Settings {
    ...
    var autoSyncEnabled: Boolean
        ...
        set(value) {
            ...
            // Al activarlo por primera vez se parte de "ahora": si no, la primera pasada
            // vería toda la carpeta como novedad y comprimiría el carrete entero de golpe.
            if (value && autoSyncLastCheckedMillis == 0L) {
                autoSyncLastCheckedMillis = System.currentTimeMillis()
            }
